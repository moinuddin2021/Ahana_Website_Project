...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/events.css?v=<?php echo time(); ?> ">
  ...
  <body onload="loaderFunction()">
           ...
           <div class="col-lg-6">
             <div class="our-events-box">
               <div class="row">
                 <div class="col-md-6">
                   <div class="our-events-img">
                     <img class="img-fluid" src="img/publicImg/upcoming-events-img5.jpg">
                   </div>
                 </div>
                 <div class="col-md-6">
                   <div class="our-events-text">
           ...
           <div class="col-lg-6">
             <div class="our-events-box">
               <div class="row">
                 <div class="col-md-6">
                   <div class="our-events-img">
                     <img class="img-fluid" src="img/publicImg/upcoming-events-img6.jpg">
                   </div>
                 </div>
                 <div class="col-md-6">
                   <div class="our-events-text">
           ...
           <div class="col-lg-6">
             <div class="our-events-box">
               <div class="row">
                 <div class="col-md-6">
                   <div class="our-events-img">
                     <img class="img-fluid" src="img/publicImg/upcoming-events-img7.jpg">
                   </div>
                 </div>
                 <div class="col-md-6">
                   <div class="our-events-text">
           ...
           <div class="col-lg-6">
             <div class="our-events-box">
               <div class="row">
                 <div class="col-md-6">
                   <div class="our-events-img">
                     <img class="img-fluid" src="img/publicImg/upcoming-events-img8.jpg">
                   </div>
                 </div>
                 <div class="col-md-6">
                   <div class="our-events-text">
           ...
           <div class="col-lg-6">
             <div class="our-events-box">
               <div class="row">
                 <div class="col-md-6">
                   <div class="our-events-img">
                     <img class="img-fluid" src="img/publicImg/upcoming-events-img9.jpg">
                   </div>
                 </div>
                 <div class="col-md-6">
                   <div class="our-events-text">
    ...
    <!----- Our Events Second Section Start ----->
      <section class="our-events-second-section">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="our-events-img">
                <img class="img-fluid" src="img/publicImg/our-events-second- section-img.jpg">
              </div>
              <div class="our-events-img-text-content">
               <div class="row">
                 <div class="col-md-9">
                   <h2>Yoga Therapy</h2>
    ...
    <!----- Our Events Second Section End ----->
    <!----- Our Events Third Section Start ----->
     <section class="our-events-third-section">
       <div class="container">
         <div class="row">
           <div class="col-md-6">
             <div class="our-events-third-section-map">
           ...
           <div class="col-md-6">
             <div class="our-events-third-section-text">
    ...
    <!----- Our Events Third Section End ----->
    <!----- Our Events Card Start ----->
     <section class="our-events-card">
       <div class="container">
         <div class="row">
           <div class="col-md-6">
             <div class="card">
