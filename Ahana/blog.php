          ...
          <div class="row">
             <div class="col-lg-4 col-md-6">
                <div class="card">
                   ...
                   <div class="our-blog-social-icon">
                      <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="card">
                   <div class="our-blog-img">
                     <img class="img-fluid" src="img/publicImg/about-course-benefit-img4.jpg">
                   </div>
                   <div class="our-blog-text">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="card">
                   <div class="our-blog-img">
                     <img class="img-fluid" src="img/publicImg/about-course-benefit-img5.jpg">
                   </div>
                   <div class="our-blog-text">
                     <h2>Movements for Slim</h2>
                     <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
                   </div><hr>
                   <div class="our-blog-social-icon">
                     <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="card">
                   <div class="our-blog-img">
                     <img class="img-fluid" src="img/publicImg/about-course-benefit-img6.jpg">
                   </div>
                   <div class="our-blog-text">
                     <h2>Update Training Trend</h2>
                     <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
                   </div><hr>
                   <div class="our-blog-social-icon">
                     <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="card">
                   <div class="our-blog-img">
                     <img class="img-fluid" src="img/publicImg/about-course-benefit-img7.jpg">
                   </div>
                   <div class="our-blog-text">
                     <h2>Have a Toned Body</h2>
                     <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
                   </div><hr>
                   <div class="our-blog-social-icon">
                     <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="card">
                   <div class="our-blog-img">
                     <img class="img-fluid" src="img/publicImg/about-course-benefit-img8.jpg">
                   </div>
                   <div class="our-blog-text">
                     <h2>Rapid Weight Loss</h2>
                     <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
                   </div><hr>
                   <div class="our-blog-social-icon">
                     <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="card">
                   <div class="our-blog-img">
                     <img class="img-fluid" src="img/publicImg/about-course-benefit-img9.jpg">
                   </div>
                   <div class="our-blog-text">
                     <h2>Healthy Eating Mode</h2>
                     <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
                   </div><hr>
                   <div class="our-blog-social-icon">
                     <div class="row">
