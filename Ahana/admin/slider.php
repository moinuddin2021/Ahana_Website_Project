  ...
  <?php
   ...
   if (isset($_POST['upload']))
   {
        ...
        if($fileerror == 0) 
        {
           ...
           $uploadquery = "INSERT INTO slider (photo) VALUES('$destfile')";
               ...
               while($result = mysqli_fetch_array($query)) 
               {
                ?>
                  <tr>
                    ...
                    <td><a href="sliderdelete.php?id=<?php echo $result['id'] ?>"><i class="fas fa-trash-alt" data-toggle="tooltip" data-placement="top" title="Delete"></i></a></td>
                  </tr> 
                <?php
               } 
              ?> 
